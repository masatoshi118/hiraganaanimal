...
|機能|記号|説明|
|:-----------|:------------|:------------|
|見出し|# + スペース|#の数により見出しの大きさを変えることができます|
|箇条書き（点）|* + スペース|点（・）で箇条書きができます|
|箇条書き（数字）|数字. + スペース|番号つきの箇条書きを作ることができます|
|取り消し線|~~　~~|波線二つで囲む事で取り消し線を書くことができます|
|太文字|** **|アスタリスク二つで囲む事で太文字にすることができます|
|イタリック体|* *|アスタリスク一つで囲むとイタリック体にすることができます|
|コード(背景色)|``|バッククオート一つで囲むと文字色または背景色をつけることができます|
|改行|`<br>`|`<br>`を書いたところで改行することができます|

<br>

ここに含まれないものもあるので目を通してみて下さい。
...
シャープ（`# + スペース`）を頭につけると見出しを作ることができます。数により見出しの大きさを変えることができます。
